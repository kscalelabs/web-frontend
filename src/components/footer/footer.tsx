...
export default function Footer() {
    ...
    const CopyRight = () => {
        return (
            <p className={'font-planar font-light w1440:text-lg w1024:text-md w640:text-sm text-off-white ' +
            ...
            <div className={'flex flex-col cols-span-1 gap-24'}>
                <div className={"flex flex-col cols-span-1 gap-20 w-[100%]"}>
                    <section className={"flex flex-col items-start gap-16 col-span-1"}>
                        ...
                        <FooterSectionList title={"Get in touch"}
                    ...
                    <section className={"flex flex-row justify-between gap-12 col-span-1"}>
                        <FooterSectionList title={"Product"}
                                           ...
                                           itemUrls={["https://shop.kscale.dev/products/gpr-basic", "https://forms.gle/HB5uj5r5mGQZUBtd8"]}
