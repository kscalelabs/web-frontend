    ...
    <section className="col-span-full grid grid-cols-subgrid auto-rows-min gap-y-4 py-16 ">
      ...
      <article className="col-span-full grid grid-cols-subgrid gap-y-4">
        ...
        <div className="col-span-full grid grid-cols-subgrid">
          ...
          <div className="col-span-full px-4 sm:px-0 sm:col-span-8 sm:col-start-2 md:col-span-5 md:col-start-7 lg:col-span-5 lg:col-start-7 2xl:col-span-5 2xl:col-start-7">
