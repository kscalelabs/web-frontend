    ...
    <section className="section">
      <div className="col-span-default col-start-default mb-8">
        ...
        <p className="text-body-1">
          We own the entire stack&mdash;from designing and manufacturing the hardware to developing
          the operating system and training state-of-the-art machine learning models on our own
          infrastructure. Every layer is built in-house.
        </p>
      </div>
