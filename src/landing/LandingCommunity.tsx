  ...
  return (
    <section className="section">
      <div className="section-container">
        ...
        <figure className="col-span-full sm:col-span-2 lg:col-span-3 lg:col-start-1 2xl:col-span-2 2xl:col-start-2 4xl:col-span-4 4xl:col-start-2 aspect-square sm:aspect-video rounded-lg relative overflow-hidden mb-4 md:mb-6">
          <Image
        ...
        <figure className="col-span-full sm:col-span-2 lg:col-span-3 2xl:col-span-2 4xl:col-span-2 aspect-square sm:aspect-video rounded-lg relative overflow-hidden mb-4 md:mb-6">
          <Image
        ...
        <figure className="col-span-full sm:col-span-2 sm:col-start-2 lg:col-span-4 lg:col-start-2 2xl:col-start-3 2xl:col-span-2 4xl:col-start-3 4xl:col-span-4  aspect-square sm:aspect-video rounded-lg relative overflow-hidden mb-4 md:mb-6">
          <Image
