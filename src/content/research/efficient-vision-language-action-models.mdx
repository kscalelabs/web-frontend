...
<figure>
  <img src="/research/images/evla_architecture.webp" alt="Comparison of OpenVLA vs EVLA" style={{ marginBottom: "0.1rem" }} />
<<<<<<< HEAD
<<<<<<< HEAD
    <figcaption style={{ marginBottom: "1rem", textAlign: "center" }}> The comparison of generation logic between OpenVLA and EVLA. The pretraining phase is identical for both
=======
    <figcaption style={{ marginBottom: "1rem" }}> The comparison of generation logic between OpenVLA and EVLA. The pretraining phase is identical for both
>>>>>>> cc13136 (update files, adapt mdx)
=======
    <figcaption style={{ marginBottom: "1rem", textAlign: "center" }}> The comparison of generation logic between OpenVLA and EVLA. The pretraining phase is identical for both
>>>>>>> 1a5d97f (update global css and rendering)
models. In phase two, the EVLA LLM is being retrained to generate end-effector position in an autoregressive fashion.</figcaption>
</figure>
...
<figure>
  <img src="/research/images/OpenVLA_vs_EVLA.webp" alt="OpenVLA (yellow) versus EVLA (green) on the Bridge dataset smoothed with time-weighted EMA." style={{ marginBottom: "0.1rem" }}/>
<<<<<<< HEAD
<<<<<<< HEAD
    <figcaption style={{ marginBottom: "1rem" , textAlign: "center" }}>OpenVLA (yellow) versus EVLA (green) on the Bridge dataset smoothed with time-weighted EMA.</figcaption>
</figure>
=======
    <figcaption style={{ marginBottom: "1rem" }}>OpenVLA (yellow) versus EVLA (green) on the Bridge dataset smoothed with time-weighted EMA.</figcaption>
</figure>
...
<<<<<<< HEAD
  <img src="/research/images/OpenVLA_vs_EVLA_OXE.webp" alt="." style={{ marginBottom: "0.1rem" }}/>
    <figcaption style={{ marginBottom: "1rem", textAlign: "center" }}>OpenVLA (grey) versus EVLA (pink) on the full OXE dataset smoothed with time-weighted EMA.</figcaption>
</figure>
=======
  <img src="/research/images/OpenVLA_vs_EVLA_OXE.webp" alt="OpenVLA (grey) versus EVLA (pink) on the full OXE dataset smoothed with time-weighted EMA." style={{ marginBottom: "0.1rem" }}/>
    <figcaption style={{ marginBottom: "1rem" }}>OpenVLA (grey) versus EVLA (pink) on the full OXE dataset smoothed with time-weighted EMA.</figcaption>
</figure>
...
<figure>
  <img src="/research/images/Evaluation_ A100.webp" alt="Evaluation performed on A100–40GB."     style={{ marginBottom: "0.1rem", width: "600px" }} />
<<<<<<< HEAD
<<<<<<< HEAD
  <figcaption style={{ marginBottom: "1rem", textAlign: "center"  }}>Evaluation performed on A100–40GB.</figcaption>
</figure>
=======
  <figcaption style={{ marginBottom: "1rem" }}>Evaluation performed on A100–40GB.</figcaption>
</figure>
