...
<<<<<<< HEAD
=======
## Sound stream for humanoid with efficient tokenization
...
If you want to try the tokenizer, we share K-Scale Speech Tokenizer family of models and accompanying [Github] 
repository(https://github.com/kscalelabs/kst). 
$ 123$
...
processing audio at 16kHz produces 50 frames per second. This corresponds to 4000/50 = 80 bits allocated to each frame. 
...
<<<<<<< HEAD
<figure>
  <img src="/research/images/encodec.webp" alt="RVQ." style={{ width: "90%", display: "block", margin: "0 auto", marginBottom: "0.1rem" }}/>
  <figcaption style={{ marginBottom: "1rem", textAlign: "center" }}>Tokenizer with Residual Vector Quantizer.</figcaption>
=======

<figure>
  <img src="/research/images/encodec.webp" alt="RVQ."  style={{ width: "70%", marginBottom: "0.1rem" }}/>
  <figcaption style={{ marginBottom: "1rem" }}>Tokenizer with Residual Vector Quantizer..</figcaption>
>>>>>>> cc13136 (update files, adapt mdx)
=======
<figure>
  <img src="/research/images/encodec.webp" alt="RVQ." style={{ width: "90%", display: "block", margin: "0 auto", marginBottom: "0.1rem" }}/>
...
<<<<<<< HEAD
<<<<<<< HEAD
  <figcaption style={{ marginBottom: "1rem", textAlign: "center" }}> Lookup Free Quantizer Architecture.</figcaption>
</figure>
Since LFQ is a single-layer quantizer, we operate at 8 times smaller bit rate than with RVQ which results in 500 bps. 
=======
  <figcaption style={{ marginBottom: "1rem" }}> Lookup Free Quantizer Architecture.</figcaption>
</figure>
>>>>>>> cc13136 (update files, adapt mdx)
=======
  <figcaption style={{ marginBottom: "1rem", textAlign: "center" }}> Lookup Free Quantizer Architecture.</figcaption>
...
<<<<<<< HEAD
<<<<<<< HEAD
  <figcaption style={{ marginBottom: "1rem", textAlign: "center" }}> KST - LFQ quantization with Semantic Alignment against HuBERT Tokens.</figcaption>
</figure>

## Aligning with Human-like Information
=======
  <figcaption style={{ marginBottom: "1rem" }}> KST - LFQ quantization with Semantic Alignment against HuBERT Tokens.</figcaption>
</figure>
...
from the LibriVox project. For effective comparison, we have kept the original training parameters of the SpeechTokenizer. Efficient tokenization can be efficiently trained - we used two nodes of A100s over a span of 4 days for each model. All models consists of around 100M parameters. You can see the full training config at the KST repository.
...
<figure>
  <img src="/research/images/table_lfq.png" alt="RVQ." width="50%" style={{ marginBottom: "0.1rem" }} />
<<<<<<< HEAD
<<<<<<< HEAD
  <figcaption style={{ marginBottom: "1rem", textAlign: "center" }}> Speech reconstruction results.</figcaption>
=======
  <figcaption style={{ marginBottom: "1rem" }}> Speech reconstruction results.</figcaption>
>>>>>>> cc13136 (update files, adapt mdx)
=======
  <figcaption style={{ marginBottom: "1rem", textAlign: "center" }}> Speech reconstruction results.</figcaption>
>>>>>>> 1a5d97f (update global css and rendering)
...
{/* We did not observe significant variations in reconstruction quality or performance 
across different codebook sizes within LFQ, therefore we present results only for the 
1024 codebook configuration. */}
...
comprising of 6M parameters and around 2 hours of artificially generated speech data
...
[4] See recent robotics tokenizers: [Cosmos](https://github.com/NVlabs/TokenBench) tokenizer or [FAST tokenizer](https://www.physicalintelligence.company/research/fast) \
