...
<figure>
  <img src="/research/images/kst.png" alt="RV Q." width="50%" style={{ marginBottom: "0.1rem" }} />
  <figcaption style={{ marginBottom: "1rem", textAlign: "center" }}>
    {" "}
    KST - LFQ quantization with Semantic Alignment against HuBERT Tokens.
  </figcaption>
...
{/_ We did not observe significant variations in reconstruction quality or performance
across different codebook sizes within LFQ, therefore we present results only for the
1024 codebook configuration. _/}
