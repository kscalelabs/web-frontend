...
<div id="footnote-1">
  [1] [Even if we yell at them.](https://yay-robot.github.io/) \ [2]
  [EdgeVLA](https://kscale.dev/research/efficient-video-language-action-models-for-robots) \ [3]
  [MagVIT2](https://magvit.cs.cmu.edu/v2/) \ [4] See recent robotics tokenizers:
  [Cosmos](https://github.com/NVlabs/TokenBench) tokenizer or [FAST
  tokenizer](https://www.physicalintelligence.company/research/fast) \ [5]
  [HuBERT](https://ieeexplore.ieee.org/abstract/document/9585401) \ [6]
